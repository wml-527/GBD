...
甘油三酯 = st.number_input("甘油三酯(TG):", min_value=0.1, max_value=20.0, step=0.1,value=0)
低密度脂蛋白胆固醇 = st.number_input("低密度脂蛋白胆固醇(LDL-C):", min_value=0.5, max_value=10.0,  step=0.1,value=0)
高密度脂蛋白胆固醇 = st.number_input("高密度脂蛋白胆固醇(HDL-C):", min_value=0.1, max_value=5.0, step=0.1,value=0)
谷丙转氨酶 = st.number_input("谷丙转氨酶(ALT):", min_value=0, max_value=500,  step=1,value=0)
谷草酶谷丙酶 = st.number_input("谷草酶谷丙酶(AST/ALT):", min_value=0.1, max_value=5.0, step=0.1,value=0)
总蛋白 = st.number_input("总蛋白(TP):", min_value=40, max_value=100, step=1,value=0)
白蛋白 = st.number_input("白蛋白(ALB):", min_value=20, max_value=70, step=1,value=0)
血肌酐 = st.number_input("血肌酐(Scr):", min_value=10, max_value=500, step=1,value=0)
血尿酸 = st.number_input("血尿酸(UA):", min_value=50, max_value=1000, step=1,value=0)
空腹血糖 = st.number_input("空腹血糖(FBG):", min_value=2.0, max_value=20.0,  step=0.1,value=0)
白细胞 = st.number_input("白细胞(WBC):", min_value=1.0, max_value=30.0,  step=0.1,value=0)
淋巴细胞计数 = st.number_input("淋巴细胞计数(LYM#):", min_value=0.1, max_value=10.0, step=0.1,value=0)
平均血红蛋白 = st.number_input("平均血红蛋白(MCH):", min_value=20, max_value=50, step=1,value=0)
血小板 = st.number_input("血小板(PLT):", min_value=20, max_value=1000, step=1,value=0)
