...
甘油三酯 = st.number_input("甘油三酯(TG):", min_value=0, max_value=20.0, value=0, step=0.1)
低密度脂蛋白胆固醇 = st.number_input("低密度脂蛋白胆固醇(LDL-C):", min_value=0, max_value=10.0, value=0, step=0.1)
高密度脂蛋白胆固醇 = st.number_input("高密度脂蛋白胆固醇(HDL-C):", min_value=0, max_value=5.0, value=0, step=0.1)
谷丙转氨酶 = st.number_input("谷丙转氨酶(ALT):", min_value=0, max_value=500, value=0, step=1)
谷草酶谷丙酶 = st.number_input("谷草酶谷丙酶(AST/ALT):", min_value=0, max_value=5.0, value=0, step=0.1)
...
空腹血糖 = st.number_input("空腹血糖(FBG):", min_value=0, max_value=20.0, value=0, step=0.1)
白细胞 = st.number_input("白细胞(WBC):", min_value=0, max_value=30.0, value=0, step=0.1)
淋巴细胞计数 = st.number_input("淋巴细胞计数(LYM#):", min_value=0, max_value=0, value=2.0, step=0.1)
平均血红蛋白 = st.number_input("平均血红蛋白(MCH):", min_value=0, max_value=50, value=0, step=1)
血小板 = st.number_input("血小板(PLT):", min_value=0, max_value=10000, value=0, step=1)
